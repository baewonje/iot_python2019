...
con = MySQLdb.connect(host='localhost', port=3306, db='suppliers_2012', user='root', passwd='1111')
c = con.cursor()


item_numbers_file = sys.argv[1] #item_numbers_to_fin.csv
path_to_folder = sys.argv[2] # historical_files
output_file = sys.argv[3] # output_files/output.csv
